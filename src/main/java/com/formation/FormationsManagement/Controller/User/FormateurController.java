...
public class FormateurController {
   ...
   @PreAuthorize("hasRole('USER')")
    ...
    @PreAuthorize("hasRole('USER') or hasRole('ADMIN')")
     public HashMap<String,Integer> countFormateurType() {
    	List<Formateur> internes = formateurService.typeFormateur("interne");
    	List<Formateur> externes = formateurService.typeFormateur("externe");
    	HashMap<String, Integer> result = new HashMap<String, Integer>();
    	result.put("interne", internes.size());
    	result.put("externe", externes.size());
         return result;
     }
}
